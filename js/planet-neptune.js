//Create our scene
var neptuneScreen = new Solar.Scene("neptune");
...
Solar.loader.on('complete',function(loader,resources) {
    ...
    //Info box title
    var title = new PIXI.Text("Neptune",titleStyle);
        title.x = 1200;
        title.y = 100;
    ...
    //Create our copy of the neptune
    var planet = new PIXI.Sprite(resources.neptune.texture);
        planet.width = 200;
        planet.height = 200;
	...
	scene.transition = async function() {
		...
		//if (Solar.currentScene.name == "idle") {
            ...
            //While the real neptune is on the stage, let's grab its coordinates
            var planetPos = targetPlanet.getGlobalPosition();
            var planetBounds = targetPlanet.getBounds();
            //And set our neptune to them
